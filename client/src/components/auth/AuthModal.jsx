...
export default function AuthModal({ isOpen, onClose, initialMode = 'login' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md max-h-[95vh] overflow-y-auto bg-gray-50 rounded-2xl sm:rounded-3xl border border-gray-200 shadow-2xl animate-fadeIn">
        {/* Close button */}
        <button
          onClick={handleClose}
          className="absolute top-4 right-4 p-2 text-gray-500 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors z-10"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="px-5 sm:px-8 pb-6 sm:pb-8">
          ...
          {mode === 'login' && (
            <form onSubmit={handleLogin} className="space-y-4 sm:space-y-5">
              <div>
                <label htmlFor="login-email" className="block text-sm font-medium text-gray-600 mb-1.5 sm:mb-2">
                  Email Address
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 bg-gray-100 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all text-sm sm:text-base"
              ...
              <div>
                <label htmlFor="login-password" className="block text-sm font-medium text-gray-600 mb-1.5 sm:mb-2">
                  Password
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-2.5 sm:py-3 bg-gray-100 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all text-sm sm:text-base"
                    placeholder="••••••••"
                    required
          ...
          {mode === 'register' && (
            <form onSubmit={handleRegister} className="space-y-3 sm:space-y-4">
              <div>
                <label htmlFor="register-name" className="block text-sm font-medium text-gray-600 mb-1 sm:mb-2">
                  Full Name
                </label>
                <div className="relative">
              ...
              <div>
                <label htmlFor="register-email" className="block text-sm font-medium text-gray-600 mb-1 sm:mb-2">
                  Email Address
                </label>
                <div className="relative">
                  <Mail className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400" />
              ...
              <div>
                <label htmlFor="register-password" className="block text-sm font-medium text-gray-600 mb-1 sm:mb-2">
                  Password
                </label>
                <div className="relative">
                  <Lock className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400" />
              ...
              <div>
                <label htmlFor="register-confirm" className="block text-sm font-medium text-gray-600 mb-1 sm:mb-2">
                  Confirm Password
                </label>
                <div className="relative">
                  <Lock className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400" />
          ...
          {mode === 'forgot' && (
            <form onSubmit={handleForgotPassword} className="space-y-4 sm:space-y-5">
              <div>
                <label htmlFor="forgot-email" className="block text-sm font-medium text-gray-600 mb-1.5 sm:mb-2">
                  Email Address
                </label>
                <div className="relative">
                  <Mail className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400" />
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 text-gray-500 hover:text-gray-900 transition-colors text-sm"
              >
          ...
          {/* Toggle mode */}
          {mode !== 'forgot' && (
            <p className="mt-4 sm:mt-6 text-center text-gray-500 text-sm sm:text-base">
              {mode === 'login' ? (
                <>
