...
export default function PeptideRecommendations({ recommendations }) {
  return (
    <div className="card">
...
function PeptideCard({ peptide, priority }) {
  const colorClass = priorityColors[priority] || 'bg-gray-100 text-gray-700 border-gray-200'
